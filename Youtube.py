...
# New (primary) API
API_URL = os.environ.get("SHRUTI_API_URL", "")
...
NUBCODERS_API_TOKEN = os.environ.get("NUBCODERS_API_TOKEN", "")

# Old (last-resort fallback) API — used if both of the above fail
OLD_API_URL = os.environ.get("MEOW_API_URL", "")
OLD_API_KEY = os.environ.get("MEOW_API_KEY", "")
